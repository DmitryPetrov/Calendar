...
public class HtmlTableMonthCreator {
    ...
    private void printRecordedDay(StringBuilder table, int i, Day day,
        ...
        table.append("\n\t<td class=\"" + day.getMoodString()
                + "\" title=\"” вас было " + translateMood(day) + " настроение\">");
        table.append(i);
    ...
    private String chooseIco(String dayAttribute) {
        ...
        switch (dayAttribute) {
        case "useful":
            ico = "<i class=\"fa fa-list-ol fa-lg\" title=\"Ётот день вы провели с пользой\"></i>";
            break;
        case "work":
            ico = "<i class=\"fa fa-industry fa-lg\" title=\"¬ этот день вы работали\"></i>";
            break;
        case "study":
            ico = "<i class=\"fa fa-graduation-cap fa-lg\" title=\"¬ этот день вы учились\"></i>";
            break;
        case "learn_language":
            ico = "<i class=\"fa fa-language fa-lg\" title=\"¬ этот день вы практиковались в иностранных €зыках\"></i>";
            break;
        case "sport":
            ico = "<i class=\"fa fa-futbol-o fa-lg\" title=\"¬ этот день вы занимались спортом\"></i>";
            break;
        case "alcohol":
            ico = "<i class=\"fa fa-glass fa-lg\" title=\"¬ этот день вы употребл€ли алкоголь\"></i>";
            break;
        case "smoke":
            ico = "<i class=\"fa fa-fire fa-lg\" title=\"¬ этот день вы курили\"></i>";
            break;
        default:
            ico = "";
        }
